 ...
 * @author bgiles
 */
public class PadovanSequenceTest extends AbstractRecurrenceSequenceTest<BigInteger> {
    /**
    * Constructor
    */
    public PadovanSequenceTest() throws NoSuchMethodException {
        super(PadovanSequence.class);
    }
    ...
    public void verifyInitialTerms() {
        verifyInitialTerms(Arrays.asList(ONE, ZERO, ZERO, ONE, ZERO, ONE, ONE));
    }

    /**
     * Verify a(n) = a(n-1) + a(n-5)
     */

    /**
     * Verify a(n+5) = sum(a(i)) from 1 to n.
     */
    @Test
