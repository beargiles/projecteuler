...
import com.invariantproperties.projecteuler.figurate.SquareNumber;

import java.util.Arrays;


public class SquareNumberTest extends AbstractFigurateTest<Long> {
    /**
     * Constructor.
     */
    public SquareNumberTest() throws NoSuchMethodException {
        super(SquareNumber.class);
    }
    ...
    public void verifyInitialTerms() {
        verifyInitialTerms(Arrays.asList(0L, 1L, 4L, 9L, 16L, 25L, 36L, 49L,
                64L, 81L, 100L, 121L, 144L));
    }
}
