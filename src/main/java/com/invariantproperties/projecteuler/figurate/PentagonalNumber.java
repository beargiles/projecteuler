 ...
 *
 */
@com.invariantproperties.projecteuler.annotation.Sequence(oeis = "A00326")
public final class PentagonalNumber extends PolygonalNumber {
    /**
     * @param n
     */
     ...
     * @param endIndex
     */
    public PentagonalNumber(int startIndex, int endIndex) {
        super(5, startIndex, endIndex);
    }
    ...
    public SequenceList<Long> subList(int fromIndex, int toIndex) {
        return new PentagonalNumber(fromIndex, toIndex);
    }
}
