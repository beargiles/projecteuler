 ...
 *
 */
@com.invariantproperties.projecteuler.annotation.Sequence(oeis = "A000566")
public final class HeptagonalNumber extends PolygonalNumber {
    /**
     * @param n
     */
     ...
     * @param endIndex
     */
    public HeptagonalNumber(int startIndex, int endIndex) {
        super(7, startIndex, endIndex);
    }
    ...
    public SequenceList<Long> subList(int fromIndex, int toIndex) {
        return new HeptagonalNumber(fromIndex, toIndex);
    }
}
