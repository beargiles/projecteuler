 ...
 *
 */
@com.invariantproperties.projecteuler.annotation.Sequence(oeis = "A00290")
public final class SquareNumber extends PolygonalNumber {
    /**
     * @param n
     */
    public SquareNumber() {
     ...
     * @param endIndex
     */
    public SquareNumber(int startIndex, int endIndex) {
        super(4, startIndex, endIndex);
    }
    ...
    public SequenceList<Long> subList(int fromIndex, int toIndex) {
        return new SquareNumber(fromIndex, toIndex);
    }
}
