 ...
 *
 */
@com.invariantproperties.projecteuler.annotation.Sequence(oeis = "A00384")
public final class HexagonalNumber extends PolygonalNumber {
    /**
     * @param n
     */
     ...
     * @param endIndex
     */
    public HexagonalNumber(int startIndex, int endIndex) {
        super(6, startIndex, endIndex);
    }
    ...
    public SequenceList<Long> subList(int fromIndex, int toIndex) {
        return new HexagonalNumber(fromIndex, toIndex);
    }
}
